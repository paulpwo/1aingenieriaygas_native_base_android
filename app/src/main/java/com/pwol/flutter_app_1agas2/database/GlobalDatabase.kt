...
import com.pwol.flutter_app_1agas2.database.departaments.MunicipalityDao
...
@Database(entities = [Service::class, Faq::class, Departament::class, Municipality::class], version = 2)
abstract class GlobalDatabase : RoomDatabase() {
    abstract fun serviceDao(): ServiceDao
    abstract fun departamentDao(): DepartamentDao
    abstract fun faqDao(): FaqDao
    abstract fun municypalityDao(): MunicipalityDao
            ...
            INSTANCE ?: synchronized(this) {
                val MIGRATION_1_2 = object : Migration(1, 2) {
                    override fun migrate(database: SupportSQLiteDatabase) {
                        ...
                        database.execSQL(
                            "INSERT INTO Municipalities (id_municipio, municipio, estado, departamento_id)  " +
                                    " VALUES " +
                                    "(1,'Abriaquí',1,5)," +
                                    "(2,'Acacías',1,50)," +
                                    "(3,'Acandí',1,27)," +
